...
export default function WhyUs() {
  ...
  return (
    <div className="container mx-auto px-4 md:px-6 py-10 md:py-16">
      {/* Video hero */}
      <div className="relative w-full h-56 sm:h-72 md:h-96 lg:h-112.5 rounded-2xl overflow-hidden mb-12 md:mb-20">
        <video
        ...
        />
        <div className="absolute inset-0 bg-black/30 flex flex-col items-center justify-center text-center gap-3 md:gap-4 px-4">
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white max-w-2xl leading-tight">
            {td("whyUsTitle")}
          </h1>
      ...
      <div className="w-full">
        ...
        <div className="hidden md:grid grid-cols-3 gap-10">
          {badges.map((badge) => (
            ...
            >
              {badge.icon}
              <h3 className="font-semibold mt-1">{badge.title}</h3>
        ...
        <div className="md:hidden">
          <style>{`
            .whyus-swiper { padding-bottom: 40px !important; }
            .whyus-swiper .swiper-pagination { bottom: 0 !important; }
            .whyus-swiper .swiper-pagination-bullet { background: #9ca3af; opacity: 1; width: 8px; height: 8px; margin: 0 4px !important; }
            .whyus-swiper .swiper-pagination-bullet-active { background: #374151; }
          `}</style>
          <Swiper
            modules={[Pagination]}
          ...
          >
            {badges.map((badge) => (
              <SwiperSlide key={badge.title}>
                <div className="flex flex-col items-center gap-4 px-8 text-center pb-4">
